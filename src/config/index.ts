...
export const metricToName = {
  ...
  [Metric.ATTACK_COMPLEXITY]: { value: 'Attack Complexity', key: 'attackComplexity' },
  [Metric.PRIVILEGE_REQUIRED]: { value: 'Privilege Required', key: 'privilegeRequired' },
  [Metric.USER_INTERACTION]: { value: 'User Interaction', key: 'userInteraction' },
  [Metric.SCOPE]: { value: 'Scope', key: 'scope' },
  [Metric.CONFIDENTIALITY]: { value: 'Confidentiality', key: 'confidentiality' },
